            ...
            <div class="container">
                <div class="navbar-header">
                    ...
                    {{-- <a class="navbar-brand" href="{{ url('/') }}">
                        {{ config('app.name', 'PerdiAchei') }}
                    </a> --}}
                    <a href="#" class="navbar-brand compressed" style="margin-top:-2%;"><img src="assets/img/logo.png" alt="" data-src="assets/img/logo.png" data-src-retina="assets/img/logo.png" width="136" height="30"/></a>
                </div>
